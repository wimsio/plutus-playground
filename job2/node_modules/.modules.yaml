...
hoistedDependencies:
  ...
  packages/plugin-compiler:
    '@ide/plugin-compiler': private
  packages/plugin-file-explorer:
    '@ide/plugin-file-explorer': private
  packages/plugin-sdk:
    '@ide/plugin-sdk': private
  picocolors@1.1.1:
    picocolors: private
  postcss@8.5.8:
    postcss: private
...
pendingBuilds: []
prunedAt: Tue, 03 Mar 2026 22:21:41 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-msvc@4.59.0'
  - fsevents@2.3.3
storeDir: /home/dell_8th_gen_core_i5/.local/share/pnpm/store/v3
